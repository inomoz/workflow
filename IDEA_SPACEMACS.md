...
#2 - Super Emacs ;)                           #+2 - Documentation browser (Zeal)
...
#x - Command Runner                           #z  - Hide window
#f - Presentation mode (quick switch)         #+z - Maximize window 
#+f - Presentation mode                       #r  - Resize window
#+c - Clipboard history                       #+q - Close window
#^c - Clear Clipboard history                 #backspace - Kill Window (need click to window)
PS - Take Screen Selection                    #Up, #Down, #Left, #Right - move window to top, bottom, left, right of screen
#d - pagedown, #u - pageup                    #hjkl - move left, down, up, left
!` - walk through group                       !+` - reverse walk through group 
#PS - Take Window Screenshoot                 #F11        - Full Screen
...
G        Scroll to the bottom of the page            ab    Bookmark current page
d        Scroll a half page down                     T     Search through your open tabs
u        Scroll a half page up                       /     Enter find mode
cs       Change scroll target                        n     Cycle forward to the next find match
%        Scroll to percentage                        N     Cycle backward to the previous find match
r        Reload the page                             S     Go back in history
yy       Copy the current URL to the clipboard       D     Go forward in history
cc       Open the clipboard's URL                    yt    Duplicate current tab
yG       Capture current full page                   E     Go one tab left
yma      Copy multiple link URLs to the clipboard    R     Go one tab right
ys       Copy current page's source                  gt    Go to last activated tab
gi       Focus the first text input on the page      g0    Go to the first tab
f        Open a link in the current tab              g$    Go to the last tab
af       Open a link in a new tab                    gx$   Close all tabs on right
zi zoom in, zo zoom out, zr zoom reset               <a-p> Pin or unpin current tab
w        Switch frames                               <a-m> Mute or unmute current tab
x        Close current tab                           X     Restore closed tab
?        Show help                                   ;t    Translate selected text with google
```
